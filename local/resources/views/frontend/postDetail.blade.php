                                    ...
                                    <div class="row no-gutters item">
                                        <div class="col-4 item_img d-none d-sm-block">
                                            <a href="{{url("bai-viet/$v->id/$v->slug.html")}}"><img
                                                    src="{{url('public/backend')}}/{{$v->icon}}" alt="test"></a></div>
                                        <div class="col-12 col-md-8 item_brief">
                                            <div class="row">
                                                <div class="col-4 d-sm-none"
                                                     style="padding-right: 0; padding-top: 4px;"><a
                                                        href="{{url("bai-viet/$v->id/$v->slug.html")}}"><img
                                                            src="{{url('public/backend')}}/{{$v->icon}}" alt="test"></a>
                                                </div>
                                                <div class="col-8 col-sm-12"><h3><a
                                                            href="{{url("bai-viet/$v->id/$v->slug.html")}}">{{$v->name}}</a>
                                                    </h3></div>
                                            </div>
                                            <span>Cập nhật: {{$v->created_at}} | <a href="#">@if(isset($cateData))
                                                        {{$cateData->name}}
                                                    @endif</a></span>
                                            <p>

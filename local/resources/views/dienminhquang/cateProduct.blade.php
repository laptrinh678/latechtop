...
@section('content')
    <div class="navbar-vina">
        <div class="container">
            ...
            <a href="#">@if(isset($cateData)){{$cateData->name}}@endif</a>
        </div>
    </div>
    <!-- content catepro -->
    <div class="subpage">
                    ...
                    <div class="box_subpage">
                        <div class="cat_page">
                            <div class="row list_product gird_active">
                                @if(isset($listCatedata))
                                    @foreach($listCatedata as $v)
                                        <div class="col-6 col-sm-3 gird_format">
                                            <div class="item">
                                                <a href="{{url("san-pham/$v->cate_id/$v->slug.html")}}"
                                                   title="{{$v->name}}"><img
                                                        src="{{url('public/backend')}}/{{$v->icon}}" alt="{{$v->name}}"
                                                        title="{{$v->name}}"></a>
                                                <div>
                                                    <a href="{{url("san-pham/$v->cate_id/$v->slug.html")}}"
                                                ...
                                                <a href="/site/addCart?product_cart=454&amp;quantity_cart=1"
                                                   class="icon add_icon">
                                        ...
                                        <div class="col-6 col-sm-3 gird_format">
                                            <div class="item">
                                                ...
                                                <div>
                                                    ...
                                                    <p>
                                                        <span> @if($v2->status_price==1) Giá: {{ number_format($v2->price)}}@else Miễn phí @endif</span>
                                                    </p>
                                                </div>
                                                <a href="{{url("san-pham/$v2->cate_id/$v2->slug.html")}}"
                                                   class="icon search_icon">

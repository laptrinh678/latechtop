                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" action=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="first_name" name="name" placeholder="Nhập tên bài viết"
                                               class="form-control"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="first_name" name="price" placeholder="Nhập giá"
                                               class="form-control"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="post_type" id="" class="form-control">
                                            ...
                                            <option value="2">Bài viết quan trọng</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="link_dowload" value="{{old('link_dowload')}}">
                                    </div>
                                </div>
                                ...
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button class="btn btn-primary"
                                                type="submit">{{__('message.add')}} {{ __('pages.post.name') }}</button>
                                        &nbsp; &nbsp; &nbsp;

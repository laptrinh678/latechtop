                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{Auth::user()->point}}
                                                <p>
                                                    <button class="btn btn-success">Đổi điểm sang tiền</button>
                                                </p>
                                            </td>
                                            <td>
                                                <?php
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                @if(count($userCon)>0)
                                                    <ul class="active">
                                                        <?php
                                                            function getUserCon($userCon ){
                                                                foreach($userCon as $key=>$v){
                                                                    echo '<li>';
                                                                    echo '<a href="javascript:void(0);">';
                                                                    echo  '<div class="member-view-box">';
                                                                    ...
                                                                    echo'</li>';
                                                                    unset($userCon[$key]);
                                                                    $dataCon = DB::table('users')->where('parent_user_id', $v->id)->get();
                                                                    getUserCon($dataCon);
                                                                }

                                                            }
                                                            echo getUserCon($userCon);
                                                            ?>
...
{{--                                                                                                <ul>--}}
{{--                                                                                                <?php--}}
{{--                                                                                                $dataCon3 = DB::table('users')->where('parent_user_id', $v->id)->get();--}}
{{--                                                                                                ?>--}}
{{--                                                                                                    @if(count($dataCon3)>0)--}}

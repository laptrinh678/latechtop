...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-9 right">
                    <div class="box_subpage">
                        ...
                        <div class="fb-comments" data-href="https://latechtop.com/" data-width=""
    ...
    width: 120px;" class="img-circle img-thumbnail" src="{{url('public/backend')}}/{{$imfomation->img2}}"
                            ...
                            <div>
                                <div class="row list_product">
                                    @if($postDetail->cate->posts)
                                        @foreach($postDetail->cate->posts as $postItem)
                                            <div class="col-6 col-sm-3">
                                                <div class="item">
                                                    <a href="{{url("bai-viet/$postItem->id/$postItem->slug.html")}}"
                                                       title="{{$postItem->name}}">
                                                        <img src="{{url('public/backend')}}/{{$postItem->icon}}"
                                                             alt="{{url('public/backend')}}/{{$postItem->icon}}">
                                                    </a>
                                                    <div>
                                                        <a href="{{url("bai-viet/$postItem->id/$postItem->slug.html")}}">
                                                            {{$postItem->name}}

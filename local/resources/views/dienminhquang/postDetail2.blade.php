                ...
                <div class="box_subpage">
                    ...
                    <div>
                        <p class="text-center">
                            ...
                            <a href="{{$postDetail->link_dowload}}" target="_blank"><button class="btn btn-success">Dowload</button></a>
                            @endif
                        </p>
                    </div>
                    ...
                    <div style="padding: 50px; background:#e9e9e9;">
                        ...
                        <form method="post" action="{{route('customer')}}">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" id="exampleInputEmail1" value="{{old('email')}}" aria-describedby="emailHelp" placeholder="Nhập địa chỉ email">
                                <small id="emailHelp" class="form-text text-danger" style="color:red">{{$errors->first('email')}}</small>
                                <input type="hidden" name="object_id" value="{{$postDetail->id}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Số điện thoại</label>
                                <input type="number" class="form-control" name="phone" value="{{old('phone')}}" id="exampleInputPassword1" placeholder="Nhập số điện thoại">
                                <small id="emailHelp" class="form-text text-danger"  style="color:red">{{$errors->first('phone')}}</small>
                            </div>
                            {{csrf_field()}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <p> <button type="button" class="btn btn-success clickHide">OK</button></p>
                </div>
            </div>
        </div>
    </div>

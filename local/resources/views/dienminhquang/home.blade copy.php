                            ...
                            <div class="latest_item">
                                <a href="{{ url("bai-viet/$v3->id/$v3->slug.html") }}">
                                    <img class="img-thumbnail" height="200px"
                                        src="{{ url('public/backend') }}/{{ $v3->icon }}" alt="{{ $v3->name }}">
                                </a>
                                <div>
                                    <br>
            ...
            <div class="row">
                                                                ...
                                                                <div class="col-product infobox">
                                                                    <div class="img-box">
                                                                        ...
                                                                        <a href="{{ url("san-pham/$cateId/$slug.html") }}">
                                                                            <img src="{{ url('public/backend') }}/{{ $v2[0]->icon }}"
                                                                                alt="{{ $v2[0]->name }}">
                                                                        </a>
                                                                    </div>
                                                                    <div class="title-content">
                                                                        ...
                                                                        <div class="price-box">
                                                                            <span>
                                                                                Giá:@if ($v2[0]->status_price == 1)
                                                                                    {{ number_format($v2[0]->price) }}
                                                                                @else
                                                                                    liên hệ
                                                                                @endif
                                                                            </span>
                                                                ...
                                                                <div class="col-product infobox">
                                                                    <div class="img-box">
                                                                        ...
                                                                        <a href="{{ url("san-pham/$cateId1/$slug1.html") }}">
                                                                            <img src="{{ url('public/backend') }}/{{ $v2[1]->icon }}"
                                                                                alt="{{ $v2[1]->name }}">
                                                                        </a>
                                                                    </div>
                                                                    <div class="title-content">
                                                                        ...
                                                                        <div class="price-box">
                                                                            <span>
                                                                                Giá:@if ($v2[1]->status_price == 1)
                                                                                    {{ number_format($v2[1]->price) }}
                                                                                @else
                                                                                    liên hệ
                                                                                @endif
                                                                            </span>
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="d-flex flex-row bd-highlight mb-3">
                        <div class="p-2 bd-highlight w-25"><a href="{{ url("san-pham/$product->cate_id/$product->slug.html") }}"><img class="w-100" src="{{ url('public/backend') }}/{{ $product->icon }}" alt=""></a></div>
                        <div class="p-2 bd-highlight w-75"><a href="{{ url("san-pham/$product->cate_id/$product->slug.html") }}">{{ $product->name }}</a></div>
                      </div>
                      @endforeach
                      @endif
                      @endforeach
                    ...
                    @foreach ($newpost->posts as $v3)
                        <div class="item">
                            <div class="latest_item">
                                ...
                                <div>
                                    <br>
                                    <h3><a href="{{ url("bai-viet/$v3->id/$v3->slug.html") }}">{{ $v3->name }}</a>
                                    </h3>
                                    <div class="brief">
                                        {!! $v3->des !!}
                                    </div>

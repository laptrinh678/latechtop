...
<section class="content-header list_user">
                 <div >
                     ...
                     <a href="{{url('admin/member/list')}}">{{ __('pages.slider.name') }}</a>
                     <a href="{{url('admin/member/add')}}">
                           <i class="fa fa-fw fa-angle-double-right"></i> {{__('message.add')}} {{ __('pages.slider.name') }}
                    </a>    
                </div>
            </section>
            <br>
            <section class="content">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i>{{ __('pages.slider.name') }}
                                </h3>
                ...
                <label for="first_name" class="col-sm-2 control-label">{{__('message.name')}} {{ __('pages.slider.name') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1">Loại slider</label>
                        <div class="col-sm-6">

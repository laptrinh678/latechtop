                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p>Ảnh đại diện:
                                                @if($v->icon)
                                                  <img src="{{url('public/backend/')}}/{{$v->icon}}" width='30px' height='40'  alt="">
                                                @endif
                                            </p>
                                            <p>Ảnh chi tiết</p>
                                            <?php
                                        ...
                                        <td>
                                            <a href="{{url('admin/post/destroy')}}/{{$v->id}}"><button class="btn btn-danger">Delete</button></a>
                                             <a href="{{url('admin/post/edit')}}/{{$v->id}}"><button class="btn btn-primary">Edit</button></a>
                                        </td>
                                    </tr>
                                    @endforeach

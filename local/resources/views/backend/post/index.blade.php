    ...
    <aside class="right-side strech" id="sideright">
        ...
        <section class="content-header list_user">
            <div>
                ...
                <a href="{{ url('admin/post/index') }}">{{ __('pages.post.name') }}</a>
                ...
                <div class="panel panel-primary ">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            <a href="{{ url('admin/post/create') }}">
                                <i class="fa fa-fw fa-angle-double-right"></i> {{ __('message.add') }}
                                {{ __('pages.post.name') }}
                            </a>
                            <i class="fa fa-fw fa-angle-double-right"></i>
                                ...
                                @foreach ($data as $k => $v)
                                    <tr>
                                        ...
                                        <td>
                                            <p>Ảnh đại diện:
                                                @if ($v->icon)
                                                    <img src="{{ url('public/backend/') }}/{{ $v->icon }}"
                                                        width='30px' height='40' alt="">
                                                @endif
                                            </p>
                                            <p>Ảnh chi tiết</p>
                                            <?php
                                            ...
                                            @if ($img_decode)
                                                @foreach ($img_decode as $val)
                                                    <img src="{{ url('public/backend/') }}/{{ $val }}"
                                                        width='30px' height='40' alt="">
                                                @endforeach
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($v->deleted_at == '')
                                                <button class="btn btn-success changeStatus" data="1"
                                                    id ="{{ $v->id }}">ON</button>
                                            @else
                                                <button class="btn btn-danger changeStatus" data=""
                                                    id ="{{ $v->id }}">OFF</button>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/post/destroy') }}/{{ $v->id }}"><button
                                                    class="btn btn-danger">Delete</button></a>
                                            <a href="{{ url('admin/post/edit') }}/{{ $v->id }}"><button

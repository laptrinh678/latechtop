...
<section class="content-header list_user">
            ...
            <section class="content">
                ...
                <label for="first_name" class="col-sm-2 control-label">{{__('message.name')}} {{__('message.product_name')}}</label>
                    <div class="col-sm-6">
                        <input type="text" id="first_name" name="name" placeholder="Nhập tên sản phẩm" value="{{old('name')}}" class="form-control" />
...
{{--                    </div>--}}
                    <div class="col-sm-2">
                        ...
                        <input type="number" value="{{old('price')}}"  name="price" placeholder="Nhập giá sản phẩm" class="form-control" />
                    </div>
                    <div class="col-sm-2">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                         <div class="form-check">
                          <input class="form-check-input type_product" type="checkbox" value="0" name="outstanding" />
                          <label class="form-check-label" for="flexCheckChecked" >Nổi bật</label>
                        </div>
                    </div>
                    <div class="col-sm-2">
                         <div class="form-check">
                          <input class="form-check-input type_product" type="checkbox" value="0" name="promotions" />

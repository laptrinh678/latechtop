...
<section class="content-header list_user">
            ...
            <section class="content">
                ...
                <label for="first_name" class="col-sm-2 control-label">Tên thành viên</label>
                    <div class="col-sm-6">
                        <input type="text" id="first_name" name="name" placeholder="Nhập tên thành viên" class="form-control required" />
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1">Email</label>
                        <div class="col-sm-6">
                            <input type="text" name="email" placeholder="Nhập email thành viên" class="form-control required">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="password" name="password" class="form-control required" placeholder="Nhập pass thành viên">

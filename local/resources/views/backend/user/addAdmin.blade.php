...
<section class="content-header list_user">
            ...
            <section class="content">
                ...
                <label for="first_name" class="col-sm-2 control-label">Tên admin</label>
                    <div class="col-sm-6">
                        <input type="text" id="first_name" name="name" placeholder="Nhập tên admin" class="form-control required" />
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1">Email</label>
                        <div class="col-sm-6">
                            <input type="text" name="email" placeholder="Nhập email admin" class="form-control required">

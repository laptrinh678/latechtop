     ...
     <aside class="right-side strech" id="sideright">
            ...
            <section class="content-header list_user">
                <div >
                     ...
                     <a href="{{url('admin/admin-users')}}">Danh sách admin</a>
                    ...
                    <div class="panel panel-primary ">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                ...
                                <span>
                                       <i class="fa fa-fw fa-angle-double-right"></i> Danh sách admin
                                </span>
                                <a href="{{url('admin/admin-user/create')}}">
                                    <i class="fa fa-fw fa-angle-double-right"></i> Thêm mới Admin
                                </a>
                            ...
                            <table class="table table-bordered " id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
{{--                                            <a href="{{url('admin/admin-delete')}}/{{$v->id}}"><button class="btn btn-danger">Xoá</button></a>--}}
                                            <a href="{{url('admin/admin-user/change-password')}}/{{$v->id}}"><button class="btn btn-warning ">Đổi Password</button></a>
                                        </td>
                                    </tr>
                                    @endforeach

                            ...
                            <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="question_groups_id" id="" class="form-control">
                                            ...
                                            <?php
                                            function showCategories($questionGroups, $parentId = 0, $char = '')
                                            {
                                                foreach ($questionGroups as $key => $items) {
                                                    if ($items->parent_id == $parentId) {
                                                        echo '<option value="' . $items->id . '">';
                                                        echo $char . $items->name;
                                                        echo '</option>';
                                                        unset($questionGroups[$key]);
                                                        showCategories($questionGroups, $items->id, $char . '|---');
                                                    }
                                                }
                                            }
                                            echo showCategories($questionGroups);
                                            ?>
                                        </select>
                                ...
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button class="btn btn-primary" type="submit">{{ __('message.add') }} câu
                                            hỏi</button>
                                        &nbsp; &nbsp; &nbsp;

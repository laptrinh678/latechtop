<div class="container">
    <div class="row">
        <h3> <a href="{{ url('/') }}" target="_blank">Tuyendungcongchuc247.com</a></h3>
        <div>
            <a href="{{ url('/') }}" target="_blank">Tuyendungcongchuc247.com</a> {{ $infor['text_send_email'] }}
        </div>
        <h4>Click vào link bên dưới sẽ mở ra mà hình có: Tên tài liệu và chữ DOWLOAD (in hoa màu xanh) sau đó bạn nhấn chữ DOWLOAD để tải tài liệu về máy</h4>
